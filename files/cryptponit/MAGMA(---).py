...
# вводится 64 символьный ключ в 16-ричной системе (если неверно - просит ввести снова)
...
# вводим текст СРАЗУ В 16-РИЧНОЙ СИСТЕМЕ
...
# синхропосылка из 16 символов 
# sync = '1234567800000003' 
sync = '336f4d296059fbe3'
