...
from script.method import clear_text, get_default_args

REPLACE_SYMBOL = input("Введите символ: ")
...
def enc(text: str, alph: str = ABC, key: str = "штурм") -> str:
    mode = MODE.ENCRYPT
...
def dec(text: str, alph: str = ABC, key: str = "штурм") -> str:
    mode = MODE.DECRYPT
    alph = remove_items_in_str(alph, "ё")
    text = clear_text(text.lower(), alph)
